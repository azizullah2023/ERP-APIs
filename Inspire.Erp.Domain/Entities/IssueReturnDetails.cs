...
{
    public partial class IssueReturnDetails
    {
        ...
        public int? IssueReturnDetailsMatId { get; set; }
        public string IssueReturnDetailsItemName { get; set; }
        public int? IssueReturnDetailsUnitId { get; set; }
        ...
        public virtual IssueReturn IssueReturnDetailsNoNavigation { get; set; }
    }
}
