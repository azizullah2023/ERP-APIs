...
namespace Inspire.Erp.Domain.Entities
{
    public partial class InspireERPNewContext : DbContext
    {
        ...
        public virtual DbSet<SalesReturnDetails1> SalesReturnDetails1 { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=.\\SQLEXPRESS;Database=InspireERPNew;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BankReceiptVoucher>(entity =>
            {
                ...
                entity.Property(e => e.BankReceiptVoucherVoucherNo)
                    .HasColumnName("Bank_Receipt_Voucher_Voucher_NO")
                    .HasMaxLength(30)
                    .IsUnicode(false);
                ...
                entity.Property(e => e.BankReceiptVoucherDelStatus)
                    .HasColumnName("Bank_Receipt_Voucher_DelStatus")
                    .HasDefaultValueSql("((0))");
            ...
            modelBuilder.Entity<ContraVoucherDetails1>(entity =>
            {
                entity.HasKey(e => e.ContraVoucherDetailsId);

                entity.ToTable("ContraVoucherDetails");
            ...
            {
                entity.HasKey(e => e.CustomerPurchaseOrderCpoId);

                entity.ToTable("Customer_Purchase_Order");

                entity.Property(e => e.CustomerPurchaseOrderCpoId)
                    .HasColumnName("Customer_Purchase_Order_CPO_ID")
                    .HasMaxLength(30)
                    .IsUnicode(false);
                ...
                entity.HasOne(d => d.CustomerPurchaseOrderCpo)
                    .WithOne(p => p.CustomerPurchaseOrder)
                    .HasPrincipalKey<VouchersNumbers>(p => p.VouchersNumbersVNo)
                    .HasForeignKey<CustomerPurchaseOrder>(d => d.CustomerPurchaseOrderCpoId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            modelBuilder.Entity<CustomerPurchaseOrderDetails>(entity =>
            {
                ...
                entity.Property(e => e.CustomerPurchaseOrderDetailsId)
                    .HasColumnName("Customer_Purchase_Order_Details_ID")
                    .ValueGeneratedNever();
                ...
                entity.Property(e => e.CustomerPurchaseOrderDetailsCpoId)
            ...
            modelBuilder.Entity<CustomerQuotation>(entity =>
            {
                ...
                entity.Property(e => e.CustomerQuotationJobId).HasColumnName("Customer_Quotation_Job_ID");
                ...
                entity.Property(e => e.CustomerQuotationVoucherType).HasColumnName("Customer_Quotation_Voucher_Type");
            ...
            modelBuilder.Entity<CustomerQuotationDetails>(entity =>
            {
                ...
                entity.Property(e => e.CustomerQuotationDetailsVoucherType).HasColumnName("Customer_Quotation_Details_Voucher_Type");

                entity.HasOne(d => d.CustomerQuotationDetailsQuotation)
                    .WithMany(p => p.CustomerQuotationDetails)
                    .HasPrincipalKey(p => p.VouchersNumbersVNo)
                    .HasForeignKey(d => d.CustomerQuotationDetailsQuotationId)
                    .HasConstraintName("FK_Customer_Quotation_Details_Vouchers_Numbers");
            });
            ...
            modelBuilder.Entity<JobMasterJobDetails>(entity =>
            {
                ...
                entity.HasOne(d => d.JobMasterJobDetailsJob)
                    ...
                    .HasConstraintName("FK_Job_Master_JobDetails_Job_Master");
            });
            ...
            modelBuilder.Entity<MasterAccountsTableoldstruct>(entity =>
            {
            ...
            modelBuilder.Entity<ProgramSettings>(entity =>
            {
                ...
                entity.Property(e => e.ProgramSettingsGenId)
                    .HasColumnName("Program_Settings_GenID")
                    .ValueGeneratedNever();
            ...
            modelBuilder.Entity<PurchaseOrderDetails1>(entity =>
            {
                ...
                entity.HasOne(d => d.PurchaseOrderDetailsNoNavigation)
                    .WithMany(p => p.PurchaseOrderDetails1)
            ...
            modelBuilder.Entity<PurchaseRequisitionDetails1>(entity =>
            {
            ...
            modelBuilder.Entity<SalesJournal1>(entity =>
            {
            ...
            modelBuilder.Entity<SalesJournalDetails1>(entity =>
            {
            ...
            modelBuilder.Entity<SalesReturn>(entity =>
            {
                ...
                entity.Property(e => e.SalesReturnNo).HasColumnName("SaSalesReturnNolesReturnId");
                ...
                entity.Property(e => e.SalesReturnDlvDate).HasColumnName("SalesReturnId");
            ...
            {
                entity.HasKey(e => e.StockRegisterStoreID);
