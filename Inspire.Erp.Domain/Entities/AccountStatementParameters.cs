...
{
    public class AccountStatementParameters
    {
        ...
        public bool? rptHideOpeningBalance { get; set; }


        public int? rptCostCenter { get; set; }

        public int? rptJob { get; set; }
        public string? rptAccount { get; set; }
        ...
        public List<string>? ViewAccountsTransactionsVoucherType { get; set; }
        //public List<ViewAccountsTransactionsVoucherType>? ViewAccountsTransactionsVoucherType { get; set; }
    }
}
