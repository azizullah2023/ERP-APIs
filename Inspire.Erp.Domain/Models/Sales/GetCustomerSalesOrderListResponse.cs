...
{
  public  class GetCustomerSalesOrderListResponse
    {
        ...
        public List<CustomerOrderDetailsListResponse> CustomerOrderDetails { get; set; }
    }
    public class CustomerOrderDetailsListResponse
    {
