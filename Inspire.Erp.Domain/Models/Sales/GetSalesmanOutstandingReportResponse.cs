...
{
   public class GetSalesmanOutstandingReportResponse
    {
        public List<GetSalesmanOutstandingReportDetailsResponse> Details { get; set; }
        public string TotalDebit { get; set; }
        public string TotalCredit { get; set; }
        public string TotalSettled { get; set; }
    ...
    public class GetSalesmanOutstandingReportDetailsResponse
    {
