   ...
   public class PurchaseReturnVoucherResponse
    {
        ...
        public string PurchaseReturnVoucherRetDateString { get; set; }
        public string PurchaseReturnVoucherVoucherId { get; set; }
        public DateTime? PurchaseReturnVoucherVoucherDate { get; set; }
        public string PurchaseReturnVoucherVoucherDateString { get; set; }
        ...
        public List<PurchaseReturnVoucherDetailResponse> PurchaseReturnVoucherDetails { get; set; }
    }
}
