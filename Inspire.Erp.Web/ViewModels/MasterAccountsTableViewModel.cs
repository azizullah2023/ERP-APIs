...
{
    public class MasterAccountsTableViewModel
    {
        ...
        ////public string MasterAccountsTableOpenBalance { get; set; }
        ...
        public int? MaSno { get; set; }
        public string? MaRelativeNo { get; set; }
        public string MaAccNo { get; set; }
        public string MaAccName { get; set; }
        public string MaAccType { get; set; }
        public string MaMainHead { get; set; }
        public string MaSubHead { get; set; }
        public string MaImageKey { get; set; }
        public string MaSystemAcc { get; set; }
        public int? MaFsno { get; set; }
        public string MaStatus { get; set; }
        public int? MaUserId { get; set; }
        public DateTime? MaDateCreated { get; set; }
        public int? MaCurrencyId { get; set; }
        public string MaGpAcc { get; set; }
        public string MaAcAcc { get; set; }
        public string MaEdAcc { get; set; }
        public double? MaOpenBalance { get; set; }
        public double? MaTotalDebit { get; set; }
        public double? MaTotalCredit { get; set; }
        public string MaManualCode { get; set; }
        public bool? MaIsAirAcc { get; set; }
        public bool? MaIsSeaAcc { get; set; }
        public int? MaCostCenterId { get; set; }
        public bool? MaShowSuminTb { get; set; }
        public int? MaCostCenterSub { get; set; }
        public int? MaSortNo { get; set; }
        public double? MaAssetValue { get; set; }
        public double? MaAssetDepValue { get; set; }
        public double? MaAssetQty { get; set; }
        public double? MaLifeInYrs { get; set; }
        public string MaAssetDepMode { get; set; }
        public DateTime? MaAssetDate { get; set; }
        public bool? MaIsAsset { get; set; }
        public bool? MaDelStatus { get; set; }
